...
- [GreatDB#Database()](#new-databaseconfig---greatdbdatabase)
  - [Database#table()](#databasetablename-schema---table)
    ...
    - [table#get()](#getkeyname-string-keyvalue-fetchall-boolean---promiserowobject--null--undefined)
    - [table#has()](#haskeyname-string-keyvalue---promiseboolean)
    - [table#set()](#set-----promisevoid)
    - [table#delete()](#deletekeyname-string-keyvalue---promisevoid)
    - [table#filter()](#filteroptions---promiseany)
